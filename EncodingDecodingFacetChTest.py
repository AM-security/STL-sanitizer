...
def EncodeDecodeBytesTest():
    encoder = EncoderSTL("tests/EncodingDecodingFacetsTest/bytes/original_sphere.STL")  # carrier's filepath
    ...
    decoder = DecoderSTL("tests/EncodingDecodingFacetsTest/text/encoded/encoded_sphere.STL")  # carrier's with secret filepath
