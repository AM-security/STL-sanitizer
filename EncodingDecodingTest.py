...
def EncodeDecodeTextTest():
    ...
    encoder.EncodeFileInSTL("tests/EncodingDecodingTest/text/secret.txt",  # secret's path
                            "tests/EncodingDecodingTest/text/encoded/encoded_sphere.STL")  # path to save the carrier with secret

    decoder = DecoderSTL(
        "tests/EncodingDecodingTest/text/encoded/encoded_sphere.STL")  # carrier's with secret filepath
    decoder.DecodeFileFromSTL(
        "tests/EncodingDecodingTest/text/decoded/decoded_secret.txt")  # path to save the decoded secret
    print("\n")
...
def EncodeDecodePictureTest():
    ...
    encoder.EncodeFileInSTL("tests/EncodingDecodingTest/image/elephant_secret.jpeg",  # secret's path
                            "tests/EncodingDecodingTest/image/encoded/encoded_bunny.STL")  # path to save the carrier with secret

    decoder = DecoderSTL("tests/EncodingDecodingTest/image/encoded/encoded_bunny.STL")  # carrier's with secret filepath
    decoder.DecodeFileFromSTL(
        "tests/EncodingDecodingTest/image/decoded/decoded_secret.jpeg")  # path to save the decoded secret
    print("\n")
