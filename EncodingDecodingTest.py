...
def Test1():
    ...
    decoder = DecoderSTL(
        "TestFiles/EncodingDecodingTest/1/encoded/encoded_sphere.STL")  # carrier's with secret filepath
    decoder.DecodeFileFromSTL(
        "TestFiles/EncodingDecodingTest/1/decoded/decoded_secret.txt")  # path to save the decoded secret
...
def Test2():
    ...
    decoder.DecodeFileFromSTL(
        "TestFiles/EncodingDecodingTest/2/decoded/decoded_secret.jpeg")  # path to save the decoded secret
